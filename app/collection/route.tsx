        ...
        <div tw="flex w-full h-full p-12">
          <div tw="flex flex-col justify-between flex-1">
            ...
            >
              <g>
                ...
                <path
                  fill="#89c4f4"
                  d="m539.51,51.16c0-14.62-3.97-25.31-11.92-32.09-7.94-6.78-17.74-10.17-29.39-10.17h-2.7c-.95,0-1.96.11-3.02.32-10.38.85-19.17,4.82-26.37,11.92-7.2,7.1-11.65,15.31-13.34,24.62h-.95V13.66l-42.26,3.81v168.4l45.44-4.13v-103.26c1.06-5.08,3.44-9.74,7.15-13.98,3.7-4.23,8.52-6.67,14.46-7.31h1.27c4.45,0,8.26,1.54,11.44,4.61,3.18,3.07,4.77,8.1,4.77,15.09v104.85l45.44-4.13V51.16Z"
                />
                <polygon
                  fill="#89c4f4"
                  points="161.41 110.57 161.41 65.45 103.26 69.9 103.26 3.5 59.73 7.31 59.73 73.71 3.18 77.85 3.18 122.96 59.73 118.83 59.73 185.88 103.26 182.06 103.26 115.02 161.41 110.57"
                />
              </g>
            </svg>

            <div tw="flex flex-col">
              <p tw="text-lg">Bộ sưu tập</p>
              <h1
                style={{
                  fontFamily: "Lexend",
                }}
                tw="font-bold text-5xl m-0"
              >
                {title}
              </h1>
              {description && <p tw="text-lg">{description}</p>}
          ...
          >
            <div
              ...
              tw="bg-zinc-800/20 text-zinc-500 text-4xl flex rounded-md overflow-hidden font-bold absolute top-8 left-8"
            />
            <div
              style={{
                height: "525px",
              ...
              tw="bg-zinc-800/50 text-zinc-500 text-4xl flex rounded-md overflow-hidden font-bold absolute top-4 left-4"
            />
            <div
              style={{
                height: "525px",
              ...
              tw="bg-zinc-800 text-zinc-500 text-4xl flex rounded-md overflow-hidden font-bold absolute top-0 left-0"
            />
          </div>
        </div>
      </div>
